...
<title>Unapproved Ads | Corpers Market Place</title>
...
<p><b>Unapproved Ads </b> | </p>
<?php 
if ($result = $link->query("SELECT * FROM ads WHERE ad_status = '0' ORDER by ad_id DESC"))
{
	//display records if any
	if($result->num_rows > 0){
		//display records in a table
		echo "<table border='1' cellpadding='30' class='datatbl1'>";
		//set table headers
		echo "<tr><th>Id</th><th>Title</th><th>Type</th><th>Description</th><th>Price</th><th>State</th><th>Town</th><th>Name</th><th>Contact</th><th>Date</th><th>Status</th><th></th><th></th><th></th></tr>";
